...
class Preload extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.spritesheet('player', 'assets/player/move_sprite_4.png', {
    ...
    this.load.spritesheet('fire-shoot', 'assets/player/shoot.png', {
      frameWidth: 32, frameHeight: 46
    })
    ...
    this.load.spritesheet('miniBoss', 'assets/player/move_sprite_1.png', {
      frameWidth: 32, frameHeight: 38, spacing: 32
    })
  }
